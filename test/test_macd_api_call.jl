...
endpoint_options["short_window"] = 12
endpoint_options["long_window"] = 26
endpoint_options["signal_window"] = 9
endpoint_options["adjusted"] = true
endpoint_options["timespan"] = "day"
endpoint_options["ticker"] = "AMD"
endpoint_options["timestamp"] = nothing
endpoint_model = model(PolygonTechnicalIndicatorMACDEndpointModel, user_model, endpoint_options)
...
# make the call -
(header, df_ema, df_underlying) = api(PolygonTechnicalIndicatorMACDEndpointModel, my_url_string)