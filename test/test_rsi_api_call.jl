...
endpoint_model = model(PolygonTechnicalIndicatorRSIEndpointModel, user_model, endpoint_options)
...
# make the call -
(header, df_sma, df_underlying) = api(PolygonTechnicalIndicatorRSIEndpointModel, my_url_string)
