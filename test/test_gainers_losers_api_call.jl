...
endpoint_options["direction"] = "gainer"
endpoint_options["include_otc"] = true
endpoint_model = model(PolygonStockGainersLosers, user_model, endpoint_options)
...
# make the call -
(header, data) = api(PolygonStockGainersLosers, my_url_string)