...
contract_model_options["underlying"] = "AAPL"
contract_model_options["expiration"] = Date(2022, 06, 17)
contract_model_options["strike"] = 130.0
...
endpoint_options["timestamp"] = Date(2022, 05, 18)
endpoint_options["order"] = nothing
endpoint_options["limit"] = 1000
endpoint_options["sort"] = nothing
endpoint_model = model(PolygonOptionsQuotesEndpointModel, user_model, endpoint_options)
...
# make the call -
(header, data) = api(PolygonOptionsQuotesEndpointModel, my_url_string)
